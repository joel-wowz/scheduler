...
storiesOf('InterviewerList', module)
  ...
  .add('Initial', () => <InterviewerList interviewers={interviewers} onChange={action('onChange')} />)
  .add('Preselected', () => <InterviewerList interviewers={interviewers} value={3} onChange={action('onChange')} />);
...
storiesOf('Appointment', module)
  ...
  .add('Confirm', () => (
    <Confirm message="Delete this appointment?" onConfirm={action('onConfirm')} onCancel={action('onCancel')} />
  ))
  .add('Status', () => <Status message="Yeeting out of Existence." />)
  .add('Error', () => <Error message="OI FUCK OFF WE COULD NOT DELETE UR INTERVIEW M8" onClose={action('onClose')} />)
  .add('Edit Form', () => (
    <Form
